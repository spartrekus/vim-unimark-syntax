...
" Vim syntax file
" Language:	MRK 
" Maintainer:	Spartrekus
" Last Change:	2001 (2017, to GNU)
...
" here skip
syn keyword	cRepeat		whiledofor 
...
" functions
syn region	cStatement	start="!" skip="\\$" end="$" keepend contains=@cCommentGroup,cSpaceError,@Spell
